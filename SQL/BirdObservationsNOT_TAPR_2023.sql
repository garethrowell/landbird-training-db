...
WHERE ((LEFT(P.LocationName,4) = 'PIPE') OR (LEFT(P.LocationName,4) = 'HOCU') 
     OR (LEFT(P.LocationName,4) = 'WICR') OR (LEFT(P.LocationName,4) = 'EFMO')
     OR (LEFT(P.LocationName,4) = 'GWCA')OR (LEFT(P.LocationName,4) = 'HOME')
     OR (LEFT(P.LocationName,4) = 'LIBO')
    ) AND
