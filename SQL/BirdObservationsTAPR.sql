...
SELECT Right(E.EventName,15) AS MyDateTime, P.LocationName AS Plot, E.Temperature_C,  W.Code AS Wind, R.Code AS Precip, E.Clouds_pct AS Percent_Cloud, N.Code AS Noise, I.Name AS Interval, 
...
ORDER BY Right(E.EventName,15), P.LocationName;