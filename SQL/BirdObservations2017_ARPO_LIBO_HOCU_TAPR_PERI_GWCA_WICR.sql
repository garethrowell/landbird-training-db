...
WHERE (E.EventDateTime < CAST('20100101' AS datetime))  AND 
     ((LEFT(P.LocationName,4) = 'EFMO') OR (LEFT(P.LocationName,4) = 'LIBO') 
     OR (LEFT(P.LocationName,4) = 'HOCU') OR (LEFT(P.LocationName,4) = 'TAPR')
     OR (LEFT(P.LocationName,4) = 'PERI') OR (LEFT(P.LocationName,4) = 'GWCA')
