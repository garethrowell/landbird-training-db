...
SELECT DISTINCT Left(P.LocationName,4) AS PARK, S.TaxonCode AS AOUCode
...
WHERE (Left(P.LocationName,4) = 'ARPO') OR (Left(P.LocationName,4) = 'HOCU') OR (Left(P.LocationName,4) = 'LIBO')
