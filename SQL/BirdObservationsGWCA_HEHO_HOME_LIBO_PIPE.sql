...
WHERE (LEFT(P.LocationName,4) = 'GWCA') OR (LEFT(P.LocationName,4) = 'HEHO') OR (LEFT(P.LocationName,4) = 'HOME') OR (LEFT(P.LocationName,4) = 'LIBO') OR (LEFT(P.LocationName,4) = 'PIPE') 
