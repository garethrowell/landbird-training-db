...
SELECT P.LocationName AS Plot,  E.EventName AS Event,  B.ObservationNumber, I.Name AS Interval, 
...
WHERE ((LEFT(P.LocationName,4) = 'GWCA') OR (LEFT(P.LocationName,4) = 'TAPR') OR (LEFT(P.LocationName,4) = 'EFMO') OR 
    (LEFT(P.LocationName,4) = 'LIBO') OR (LEFT(P.LocationName,4) = 'PIPE') OR (LEFT(P.LocationName,4) = 'HOME')) AND
